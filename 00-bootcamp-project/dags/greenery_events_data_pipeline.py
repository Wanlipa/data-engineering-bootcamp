...
def _load_data_to_gcs(ds):
    # YOUR CODE HERE
    keyfile_gcs = "/opt/airflow/dags/dataengineercafe-deb3-uploading-files-to-gcs-7d01503e6a51.json"
...
def _load_data_from_gcs_to_bigquery(ds):
    # YOUR CODE HERE
    keyfile_bigquery = "/opt/airflow/dags/dataengineercafe-deb3-load-files-to-bigquery-d4f24a1fe2cf.json"
